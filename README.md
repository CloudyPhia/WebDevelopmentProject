...
Meeting Times: Wednesday 12:00 p.m. and Saturday 11:00 a.m. Extra meetings will be allocated when required.
Rules for Merge: Message other group member when you need pull request. Respond to request within 24 hours.
Rules for Work:
- If one person does not have a task/finishes their task, they must find a new task to work on and discuss their choice with the other team member.
- Complete assigned issue(s) between each meeting
Rules for Dissent: 
- If you are upset with something the other member is doing, bring it up immediately so that the problems or miscommunication can be solved
- Try to solve problems internally before going to TAs
